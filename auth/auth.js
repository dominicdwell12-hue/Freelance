  ...
  async (req, res) => {
    ...
    try {
      ...
      const result = await pool.query(
        `INSERT INTO users (email, password_hash, role, full_name, country, email_verify_token)
         VALUES ($1, $2, $3, $4, $5, $6)
         RETURNING id, email, role, full_name, created_at`,
        [email, passwordHash, role, full_name, country || null, verifyToken]
      );
      ...
      // TODO: send verification email with verifyToken via nodemailer (see utils/mailer.js)
